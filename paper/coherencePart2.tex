...
This scenario  comes from \citep[391]{olsson2005}. Equally reliable witnesses try to identify a criminal. Consider the
...
\bottomrule
\end{tabular}
\caption{Potential witnesses reports in the witness scenario.}
\label{tab:witRep}
\end{table}
