...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper34_files/figure-latex/unnamed-chunk-2-1} \end{center}
\end{subfigure}} \hfill
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper34_files/figure-latex/unnamed-chunk-4-1} \end{center}
\end{subfigure} }
\hfill
...
\begin{center}\includegraphics{coherencePaper34_files/figure-latex/unnamed-chunk-6-1} \end{center}
\end{subfigure}} \hfill
\hspace{-3cm}\begin{subfigure}[!ht]{0.4\textwidth}
...
\toprule
  & OG & OGGen & Sh & ShGen & DM & R & Fi & SZ & SL & SL.1\\
\midrule
