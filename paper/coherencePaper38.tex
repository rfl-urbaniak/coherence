...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper38_files/figure-latex/unnamed-chunk-2-1} \end{center}
\end{subfigure}} \hfill
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper38_files/figure-latex/unnamed-chunk-4-1} \end{center}
\end{subfigure} }
\hfill
...
\begin{center}\includegraphics{coherencePaper38_files/figure-latex/unnamed-chunk-6-1} \end{center}
\end{subfigure}} \hfill
\hspace{-3cm}\begin{subfigure}[!ht]{0.4\textwidth}
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper38_files/figure-latex/unnamed-chunk-10-1} \end{center}
\end{subfigure}} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper38_files/figure-latex/unnamed-chunk-13-1} \end{center}
\end{subfigure}} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper38_files/figure-latex/unnamed-chunk-17-1} \end{center}
\end{subfigure}} \hfill
