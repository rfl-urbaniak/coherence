...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-2-1} \end{center}
\end{subfigure}} \hfill
...
\textbf{Bayesian networks.} When one is forced to represent the scenario as a BN the situation is not straightforward. On one hand, the description includes probabilistic information about what die we are dealing with, but on the other, the probabilities the authors bring up (1 and .5) do not capture this information. In the simplest approach in which the information about the die is ignored, we can build a DAG containing two nodes:
\todo{tabela z nodami}
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-6-1} \end{center}
\end{subfigure}} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-9-1} \end{center}
\end{subfigure}} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-13-1} \end{center}
\end{subfigure}} \hfill
...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-19-1} \includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-19-2} \includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-19-3} \end{center}
\normalsize

\begin{figure}[H]
\begin{subfigure}[!ht]{0.4\textwidth}

\begin{center}\includegraphics{coherencePaper40_files/figure-latex/unnamed-chunk-20-1} \end{center}
\end{subfigure} \hfill
\begin{subfigure}[!ht]{0.4\textwidth}
...
\begin{center}\includegraphics[width=0.7\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-23-1} \end{center}
\end{subfigure}} \hfill
\begin{subfigure}[!ht]{0.2\textwidth}
...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-28-1} \end{center}
\end{subfigure}} \hfill
\begin{subfigure}[!ht]{0.3\textwidth}
\begin{tabular}{lr}
\toprule
...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-29-1} \end{center}
\end{subfigure}}

\scalebox{1.2}{\begin{subfigure}[!ht]{0.4\textwidth}

\begin{center}\includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-30-1} \end{center}
\end{subfigure}}
...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-33-1} \end{center}
\end{subfigure} }\hfill
...
\begin{center}\includegraphics[width=1\linewidth]{coherencePaper40_files/figure-latex/unnamed-chunk-34-1} \end{center}
\end{subfigure}} \hfill
\begin{subfigure}[!ht]{0.6\textwidth}
\centering\begingroup\fontsize{9}{11}\selectfont
